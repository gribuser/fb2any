...
const
  RegistryKey='Software\Grib Soft\FB to iSilo\1.0';
implementation
...
begin
  ...
  Filter:='iSilo documents books (*.pdb)|*.pdb|All files (*.*)|*.*';
  Title:='FB2 to iSilo v0.11 by GribUser';
  DefaultExt:='pdb';
end;
